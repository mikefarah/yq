...
var jsonScenarios = []formatScenario{
	...
	{
		description:  "Encode json: leading zero ints are decimal, not octal",
		skipDoc:      true,
		input:        "a: 040\nb: 0400\nc: 012",
		indent:       0,
		expected:     "{\"a\":40,\"b\":400,\"c\":12}\n",
		scenarioType: "encode",
	},
	{
		description:  "Encode json: leading zero ints that are not valid octal stay ints",
		skipDoc:      true,
		input:        "a: 090\nb: 018\nc: -018",
		indent:       0,
		expected:     "{\"a\":90,\"b\":18,\"c\":-18}\n",
		scenarioType: "encode",
	},
	{
		description:  "Encode json: explicit octal and float tags still respected",
		skipDoc:      true,
		input:        "a: 0o17\nb: !!float 090",
		indent:       0,
		expected:     "{\"a\":15,\"b\":90.0}\n",
		scenarioType: "encode",
	},
	{
		description:  "Encode json: plain floats are untouched",
		skipDoc:      true,
		input:        "a: 0.5",
		indent:       0,
		expected:     "{\"a\":0.5}\n",
	...
	{
		description:  "Encode json: leading zero int beyond int64 stays a float",
		skipDoc:      true,
		input:        "a: 009223372036854775808",
		indent:       0,
		expected:     "{\"a\":9223372036854776000.0}\n",
		scenarioType: "encode",
	},
	{
