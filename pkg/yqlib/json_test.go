...
var jsonScenarios = []formatScenario{
	...
	{
		description:  "Encode json: zero and negative integers",
		skipDoc:      true,
		input:        `{zero: 0, neg: -42}`,
		indent:       0,
		expected:     "{\"zero\":0,\"neg\":-42}\n",
		scenarioType: "encode",
	},
	{
		description:  "Encode json: negative zero int normalises to 0",
		skipDoc:      true,
		input:        `!!int -0`,
		indent:       0,
		expected:     "0\n",
	...
	{
		description:  "Encode json: negative integer outside int64 range",
		skipDoc:      true,
		input:        `!!int -12345678901234567890`,
		indent:       0,
