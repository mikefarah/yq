...
var yamlFormatScenarios = []formatScenario{
	...
	{
		description: "unwrapped string that would re-parse as a map is quoted",
		skipDoc:     true,
		input:       "\"this: should really work\"",
		expression:  ".",
		expected:    "\"this: should really work\"\n",
	},
	{
		description: "unwrapped string that would re-parse as an int is quoted",
		skipDoc:     true,
		input:       "\"123\"",
		expression:  ".",
		expected:    "\"123\"\n",
	...
	{
		description: "unwrapped string that would re-parse as a bool is quoted",
		skipDoc:     true,
		input:       "\"true\"",
		expression:  ".",
		expected:    "\"true\"\n",
	...
	{
		description: "unwrapped plain string stays unquoted",
		skipDoc:     true,
		input:       "\"hello world\"",
		expression:  ".",
	...
	{
		description: "unwrapped empty string stays empty",
		skipDoc:     true,
		input:       "''",
		expression:  ".",
		expected:    "\n",
